    ...
    <footer className="border-t bg-muted/30 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              <h4 className="font-semibold mb-4" data-testid="text-footer-products">
                Products
              </h4>
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li>
                  <Link href="/new-releases" data-testid="link-footer-new">
                    <span className="hover:text-foreground cursor-pointer">New Releases</span>
                  </Link>
                </li>
              </ul>
            </div>
            ...
            <div>
              <h4 className="font-semibold mb-4" data-testid="text-footer-company">
                Company
              </h4>
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li>
                  <Link href="/company" data-testid="link-footer-company">
            ...
            <div>
              <h4 className="font-semibold mb-4" data-testid="text-footer-legal">
                Legal
              </h4>
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li>
                ...
                <li>
                  <Link href="/licenses" data-testid="link-footer-licenses">
                    <span className="hover:text-foreground cursor-pointer">Licenses</span>
                  </Link>
                </li>
              </ul>
            </div>
